...
import 'package:solana_playground_app/scene/editor/widget/statement_builder/statement_builder_widget.dart';
...
class _StatementBuilderDraggableState extends State<StatementBuilderDraggable> {
  ...
  Widget topArea(BuildContext context) {
    return DragTarget<StatementBuilder>(
      ...
      onAcceptWithDetails: (drag) {
        context.read<StatementsBuilderCubit>().insertBefore(widget.builder, drag.data);
        setState(() => dropUp = null);
      },
  ...
  Widget bottomArea(BuildContext context) {
    return DragTarget<StatementBuilder>(
      ...
      onAcceptWithDetails: (drag) {
        context.read<StatementsBuilderCubit>().insertAfter(widget.builder, drag.data);
        setState(() => dropDown = null);
      },
      builder: (context, candidateData, rejectedData) {
        return Container();
