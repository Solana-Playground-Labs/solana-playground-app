...
class GenerateKeypairCommandBuilderWidget extends StatelessWidget {
  final CommandBuilderMetaInfo? metaInfo;
  final GenerateKeypairCommandBuilder builder;

  GenerateKeypairCommandBuilderWidget({
    Key? key,
    this.metaInfo,
  ...
  Widget build(BuildContext context) {
    ...
    return ComponentHeader(
      name: commandHeaderFormatter("Generate keypair", metaInfo),
        ...
        children: [
          Row(
            children: [
              ...
              TextFieldBuilderWidget<GenerateKeypairCommandBuilder>(
                style: SPLabelStyle.orange,
                adapter: TextFieldBuilderAdapter<GenerateKeypairCommandBuilder>(
                  builder: builder,
