...
import 'package:solana_playground_language/solana_playground_language.dart' as _i16;
...
import '../scene/editor_v2/solana_playground/tools/inspector/type_inspector.dart' as _i9;
...
class AppRouter extends _i13.RootStackRouter {
  AppRouter([_i14.GlobalKey<_i14.NavigatorState>? navigatorKey]) : super(navigatorKey);

  @override
  final Map<String, _i13.PageFactory> pagesMap = {
    HomeRoute.name: (routeData) {
      return _i13.MaterialPageX<dynamic>(routeData: routeData, child: const _i1.HomeView());
    },
    ...
    ImportWalletRoute.name: (routeData) {
      return _i13.MaterialPageX<dynamic>(routeData: routeData, child: const _i3.ImportWalletView());
    },
    WalletDetailRoute.name: (routeData) {
      final args = routeData.argsAs<WalletDetailRouteArgs>();
      return _i13.MaterialPageX<dynamic>(
          routeData: routeData, child: _i4.WalletDetailView(key: args.key, keypair: args.keypair));
    },
    AirdropRoute.name: (routeData) {
      final args = routeData.argsAs<AirdropRouteArgs>();
      return _i13.MaterialPageX<dynamic>(
          routeData: routeData, child: _i5.AirdropView(key: args.key, keypair: args.keypair));
    },
    EditorRoute.name: (routeData) {
      final args = routeData.argsAs<EditorRouteArgs>();
      return _i13.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i6.EditorView(key: args.key, packageEditController: args.packageEditController));
    },
    RuntimeRoute.name: (routeData) {
      final args = routeData.argsAs<RuntimeRouteArgs>();
      return _i13.CustomPage<dynamic>(
          routeData: routeData,
          child: _i7.RuntimeView(key: args.key, package: args.package, autoRun: args.autoRun),
    ...
    CreatePackageRoute.name: (routeData) {
      final args =
          routeData.argsAs<CreatePackageRouteArgs>(orElse: () => const CreatePackageRouteArgs());
      return _i13.CustomPage<dynamic>(
          routeData: routeData,
  ...
  List<_i13.RouteConfig> get routes => [
        ...
        _i13.RouteConfig(CreateKeyPairRoute.name, path: '/create-key-pair-view'),
        ...
        _i13.RouteConfig(ExpressionInspectorRoute.name, path: '/expression-inspector-view'),
...
class CreateKeyPairRoute extends _i13.PageRouteInfo<void> {
  const CreateKeyPairRoute() : super(CreateKeyPairRoute.name, path: '/create-key-pair-view');
...
class ImportWalletRoute extends _i13.PageRouteInfo<void> {
  const ImportWalletRoute() : super(ImportWalletRoute.name, path: '/import-wallet-view');
...
class WalletDetailRoute extends _i13.PageRouteInfo<WalletDetailRouteArgs> {
  WalletDetailRoute({_i14.Key? key, required _i17.Keypair keypair})
      : super(WalletDetailRoute.name,
            path: '/wallet-detail-view', args: WalletDetailRouteArgs(key: key, keypair: keypair));
...
class AirdropRoute extends _i13.PageRouteInfo<AirdropRouteArgs> {
  AirdropRoute({_i14.Key? key, required _i17.Keypair keypair})
      : super(AirdropRoute.name,
            path: '/airdrop-view', args: AirdropRouteArgs(key: key, keypair: keypair));
...
class EditorRoute extends _i13.PageRouteInfo<EditorRouteArgs> {
  EditorRoute({_i14.Key? key, required _i18.PackageEditController packageEditController})
      : super(EditorRoute.name,
            path: '/editor-view',
            args: EditorRouteArgs(key: key, packageEditController: packageEditController));
...
class RuntimeRoute extends _i13.PageRouteInfo<RuntimeRouteArgs> {
  RuntimeRoute({_i14.Key? key, required _i16.Package package, bool autoRun = true})
      : super(RuntimeRoute.name,
            path: '/runtime-view',
            args: RuntimeRouteArgs(key: key, package: package, autoRun: autoRun));

  static const String name = 'RuntimeRoute';
}

class RuntimeRouteArgs {
  const RuntimeRouteArgs({this.key, required this.package, this.autoRun = true});
...
class ExpressionInspectorRoute extends _i13.PageRouteInfo<ExpressionInspectorRouteArgs> {
  ExpressionInspectorRoute(
      {_i14.Key? key, required _i16.ExpressionBuilder builder, _i20.ExpressionMetaData? metaData})
      : super(ExpressionInspectorRoute.name,
            path: '/expression-inspector-view',
            args: ExpressionInspectorRouteArgs(key: key, builder: builder, metaData: metaData));

  static const String name = 'ExpressionInspectorRoute';
}

class ExpressionInspectorRouteArgs {
  const ExpressionInspectorRouteArgs({this.key, required this.builder, this.metaData});
...
class IconEditorRoute extends _i13.PageRouteInfo<IconEditorRouteArgs> {
  IconEditorRoute({_i14.Key? key, required _i16.SPIcon initIcon})
      : super(IconEditorRoute.name,
            path: '/icon-editor-view', args: IconEditorRouteArgs(key: key, initIcon: initIcon));
...
class ColorPickerRoute extends _i13.PageRouteInfo<ColorPickerRouteArgs> {
  ColorPickerRoute({_i14.Key? key, required _i14.Color initColor})
      : super(ColorPickerRoute.name,
            path: '/color-picker-view', args: ColorPickerRouteArgs(key: key, initColor: initColor));
...
class KeypairsListRoute extends _i13.PageRouteInfo<void> {
  const KeypairsListRoute() : super(KeypairsListRoute.name, path: '/keypairs-list-view');
