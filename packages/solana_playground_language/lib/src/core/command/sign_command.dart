...
class SignCommand extends Command {
  ...
  const SignCommand({required this.signers, required this.variable, required this.transaction});

  @override
  List<Object> get props => [signers, transaction, variable];

  factory SignCommand.fromJson(Map<String, dynamic> json) => _$SignCommandFromJson(json);
