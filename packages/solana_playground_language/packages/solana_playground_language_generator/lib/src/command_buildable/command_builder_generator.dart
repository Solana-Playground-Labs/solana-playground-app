...
import 'package:solana_playground_language_generator/src/command_buildable/command_model_visitor.dart';
import 'package:source_gen/source_gen.dart';

class CommandBuilderGenerator extends GeneratorForAnnotation<CommandBuildable> {
  @override
  dynamic generateForAnnotatedElement(
    ...
    final valueModelVisitor = CommandModelVisitor(className: element.name!);
...
String _template({
  required CommandModelVisitor model,
}) {
  final classNameBuilder = "${model.className}Builder";

  return '''
  class $classNameBuilder extends CommandBuilder {
